...
class ThumbnailManager:
    ...
    def generate_thumbnails(self, video_path: str, interval: int = 30, max_thumbnails: int = 10) -> List[Dict]:
        ...
        try:
            ...
            for i in range(num_thumbnails):
                ...
                # Save thumbnail
                thumbnail_path = os.path.join(self.thumbnails_dir, f"thumbnail_{i:03d}.jpg")
    ...
    def save_youtube_thumbnail(self, thumbnail_url: str, index: int = 0) -> Optional[Dict]:
        ...
        try:
            ...
            # Save thumbnail
            thumbnail_path = os.path.join(self.thumbnails_dir, f"yt_thumbnail_{index:03d}.jpg")
        ...
        try:
            ...
            for thumbnail in self.get_thumbnails():
                try:
                    ...
                    logger.error(f"Error removing thumbnail {thumbnail['path']}: {str(e)}")
