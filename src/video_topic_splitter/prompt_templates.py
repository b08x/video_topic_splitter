...
def get_topic_prompt(register: str, context: str) -> str:
    ...
    return templates.get(register, RegisterTemplates.get_it_workflow_topic_prompt)(context)
...
def get_analysis_prompt(register: str, context: str, transcript: str) -> str:
    ...
    return templates.get(register, RegisterTemplates.get_it_workflow_analysis_prompt)(context, transcript)
