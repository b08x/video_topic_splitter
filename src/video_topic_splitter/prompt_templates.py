...
class RegisterTemplates:
    ...
    def get_it_workflow_topic_prompt(context: str) -> str:
        """Generates a prompt for IT workflow topic analysis.

        Args:
            context (str): The text segment to analyze.

        Returns:
            str: A prompt tailored for IT workflow analysis, formatted for JSON output.  The JSON should contain:
                - topic: The main workflow topic.
                - keywords: A list of technical terms and commands.
                - relationship:  One of "CONTINUATION", "SHIFT", or "NEW", indicating the relationship to preceding segments.
                - confidence: A numerical confidence score (0-100).
        """
        return f"""
    ...
    def get_gen_ai_topic_prompt(context: str) -> str:
        """Generates a prompt for generative AI topic analysis.

        Args:
            context (str): The text segment to analyze.

        Returns:
            str: A prompt tailored for generative AI analysis, formatted for JSON output.  The JSON should contain:
                - topic: The main AI topic.
                - keywords: A list of model-specific terms and parameters.
                - relationship: One of "CONTINUATION", "SHIFT", or "NEW", indicating the relationship to preceding segments.
                - confidence: A numerical confidence score (0-100).
        """
        return f"""
    ...
    def get_tech_support_topic_prompt(context: str) -> str:
        """Generates a prompt for technical support topic analysis.

        Args:
            context (str): The text segment to analyze.

        Returns:
            str: A prompt tailored for technical support analysis, formatted for JSON output.  The JSON should contain:
                - topic: The main support topic.
                - keywords: A list of error terms and solutions.
                - relationship: One of "CONTINUATION", "SHIFT", or "NEW", indicating the relationship to preceding segments.
                - confidence: A numerical confidence score (0-100).
        """
        return f"""
    ...
    def get_it_workflow_analysis_prompt(context: str, transcript: str) -> str:
        """Generates a prompt for IT workflow video analysis (e.g., for Gemini).

        Args:
            context (str):  Additional context (may be unused).
            transcript (str): The transcript of the video segment.

        Returns:
            str: A prompt for detailed analysis of IT workflows in a video.
        """
        return f"""
    ...
    def get_gen_ai_analysis_prompt(context: str, transcript: str) -> str:
        """Generates a prompt for generative AI video analysis (e.g., for Gemini).
        ...
        Returns:
            str: A prompt for detailed analysis of generative AI aspects in a video.
        """
        return f"""
    ...
    def get_tech_support_analysis_prompt(context: str, transcript: str) -> str:
        """Generates a prompt for technical support video analysis (e.g., for Gemini).
        ...
        Returns:
            str: A prompt for detailed analysis of technical support interactions in a video.
        """
        return f"""
...
def get_topic_prompt(register: str, context: str) -> str:
    """Gets the appropriate topic analysis prompt for the given register.

    Args:
        register (str): The technical register ('it-workflow', 'gen-ai', 'tech-support').
        context (str): The text context to be analyzed.

    Returns:
        str: The prompt string.  Returns a default prompt if the register is unknown.
    """
    templates = {
...
def get_analysis_prompt(register: str, context: str, transcript: str) -> str:
    """Gets the appropriate video analysis prompt for the given register.
